// src/components/flow/InventoryNode.tsx
import React from 'react';
import { Handle, Position } from 'reactflow';
import { cn } from '@/lib/utils';

/**
 * Nodo para actualizar el inventario o registrar una transferencia de insumos.
 * Actualmente muestra un placeholder y llama al RPC `update_stock` (a implementar).
 */
export function InventoryNode({ data }: any) {
  const title = data?.title || 'Inventario';
  const description = data?.description || 'Actualizar stock';
