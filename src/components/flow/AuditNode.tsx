// src/components/flow/AuditNode.tsx
import React from 'react';
import { Handle, Position } from 'reactflow';
import { cn } from '@/lib/utils';

/**
 * Nodo para auditoría del sistema.
 * Llamará al RPC `log_audit` (pendiente de implementación).
 */
export function AuditNode({ data }: any) {
  const title = data?.title || 'Auditoría';
  const description = data?.description || 'Registrar eventos de auditoría';
