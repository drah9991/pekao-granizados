...
import type { DigitalMenuThemeStyles } from "@/hooks/useDigitalMenuConfigForm";
...
/**
 * Vista pública del cliente para la carta digital (extraída de
 * src/pages/DigitalMenu.tsx sin cambios de comportamiento). Antes vivía
 * dentro de una rama condicional del componente de página, lo que hacía que
 * su useState de tema local se llamara condicionalmente; al extraerla a su
 * propio componente ese hook queda incondicional, sin alterar el resultado.
 */
