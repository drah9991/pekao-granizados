...
/**
 * Card "Medios de Pago Aceptados" del tab de configuración del Menú Digital,
 * extraída de src/pages/DigitalMenu.tsx sin cambios de comportamiento.
 */
export function PaymentMethodsCard({ form }: PaymentMethodsCardProps) {
  const { paymentCash, setPaymentCash, paymentTransfer, setPaymentTransfer } = form;
