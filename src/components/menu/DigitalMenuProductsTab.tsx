...
interface DigitalMenuProductsTabProps {
  categories: any[];
  collapsedCategories: Record<string, boolean>;
  setCollapsedCategories: Dispatch<SetStateAction<Record<string, boolean>>>;
  toggleProductVisibility: (productId: string, currentlyPublic: boolean) => void;
}

/**
 * Tab de gestión de visibilidad de productos del Menú Digital, extraída de
 * src/pages/DigitalMenu.tsx sin cambios de comportamiento.
 */
export function DigitalMenuProductsTab({
  categories,
  collapsedCategories,
  setCollapsedCategories,
  toggleProductVisibility,
}: DigitalMenuProductsTabProps) {
  return (
