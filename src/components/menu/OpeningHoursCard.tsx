...
/**
 * Card "Horarios de Atención" del tab de configuración del Menú Digital,
 * extraída de src/pages/DigitalMenu.tsx sin cambios de comportamiento.
 */
export function OpeningHoursCard({ form }: OpeningHoursCardProps) {
  const { hours, setHours } = form;
