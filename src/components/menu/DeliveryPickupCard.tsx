...
/**
 * Card "Domicilios & Entregas" (tiempos y costos de domicilio y recogida en
 * sitio) del tab de configuración del Menú Digital, extraída de
 * src/pages/DigitalMenu.tsx sin cambios de comportamiento.
 */
export function DeliveryPickupCard({ form }: DeliveryPickupCardProps) {
  const {
