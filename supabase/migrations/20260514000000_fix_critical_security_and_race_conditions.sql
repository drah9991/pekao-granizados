...
-- 1. Fix process_sale — add FOR UPDATE lock on inventory_items
...
-- 2. Fix update_order_with_stock — restore auth check
...
-- 3. Fix cancel_sale_with_stock_restore — restore auth check
