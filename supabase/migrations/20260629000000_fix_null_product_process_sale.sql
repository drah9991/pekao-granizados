-- ==============================================================================
-- Migration: Fix Null Product ID in Sales
-- Description: Wraps the inventory logic in process_sale, update_order_with_stock,
--              and cancel_sale_with_stock_restore inside an IF product_id IS NOT NULL
--              block to prevent crashes when billing generic services.
-- ==============================================================================
...
BEGIN
    ...
    LOOP
        ...
        IF v_item.product_id IS NOT NULL THEN
            ...
            -- 2. Deducción de MEZCLA (Medición de Tanques / inventory_items & machine_tanks)
