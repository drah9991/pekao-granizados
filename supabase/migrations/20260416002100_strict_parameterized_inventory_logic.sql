...
-- Description: Unifica la lógica de descuento basándose en product_types_config.
...
BEGIN
    ...
    LOOP
        ...
        -- Solo si el tipo de producto está configurado para trackear mezcla (granizados)
