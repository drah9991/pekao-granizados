...
-- Description: Elimina las restricciones que impedían descontar del store_stock
--              cuando un producto era granizado. Ahora se descuenta SIEMPRE
--              el producto (para historial) Y la receta (para medición).
-- ==============================================================================
...
BEGIN
    ...
    LOOP
        ...
        BEGIN
            ...
            -- Determinar si el producto usa tanque (solo para lógica de ML)
            ...
            -- 1. Siempre descontamos del store_stock (Específico del producto)
            ...
            -- 3. Descontar de inventory_items vía Receta (Medición de componentes)
            FOR recipe_row IN 
